        ...
        <div class="col-7">
          <div class="center-block mb-5">
            ...
            <table class="table table-stripped table bordered">
              ...
              <?php
                $serverName="PIPEV\SQLEXPRESS";
                $connectionInfo=array ("Database"=>"Prueba");
                $con=sqlsrv_connect($serverName,$connectionInfo);
                $sl="SELECT nom_materia,docente,num_creditos FROM Materia WHERE idMateria IN (SELECT fk_idMateria FROM materia_horario)";
                $resa=sqlsrv_query($con,$sl);  
                while($row2 =sqlsrv_fetch_array($resa)){     
              ?>
              <tr>
