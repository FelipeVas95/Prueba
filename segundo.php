      ...
      <div class="container">
        <div class="row d-flex mt-5">
          ...
          <table class="table table-stripped table bordered">
                ...
                $connectionInfo='BD';// nombre de la base de datos
                $user='root';
                $pass='root';
                ...
                $res2=mysqli_query($con,$consulta);//realizacion de la consulta
                while($row =mysqli_fetch_array($res2)){    // convertir los datos en una matriz
                ?>
              <tr>
